...
If you'd like to try this out, you can copy some meaningless text from [https://hipsum.co/](https://hipsum.co/). Using _touch_, create one or more files and, using your text editor of choice (Vim, Emacs, Nano, Pico, etc.), paste in what you copied. Use grep to locate a word or pattern you know is in the file, like so:
