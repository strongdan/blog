...
Typing `scrapy shell` (you can also launch the shell with a URL like so: `scrapy shell <url>`) brings up a bunch of text, which you're not expected to read, and the shell prompt:
