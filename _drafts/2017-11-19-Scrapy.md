...
This post is a quick overview of getting started with [Scrapy](https://scrapy.org/), an open source Python-based web scraping tool that is quick to install from the shell:
