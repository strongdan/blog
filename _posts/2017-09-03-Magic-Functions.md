...
These aren't magic commands, but you can execute shell commands from within Jupyter by using the exclamation mark. For example, `!pip install numpy` will update your numpy installation. Bear in mind that not every BASH command will work using __!__.
